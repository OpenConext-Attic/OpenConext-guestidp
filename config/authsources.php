...
$config = array(
	...
	*/
	...
	'yahoo' => array(
			...
			'last',
                ...
                'attributes.optional' => array('nickname'),
                // 'sreg.validate' => FALSE,
			...
			'http://axschema.org/contact/email',
                ...
                'attributes.ax_optional' => array('http://axschema.org/namePerson/friendly'),
        ),

	// Hyves OpenID Consumer
        'hyves' => array(
                'openid:OpenIDConsumer',
                'target' => 'http://www.hyves.nl',
                'attributes.required' => array(
                        'fullname',
                        'email',
                        'first',
	...
	*/
	...
	'facebook' => array(
		...
		'api_key' => '0f259075872fc321e5ee03099cac5590',
		'secret' => '8532b63cdbf5691e6fb3c4c527beb13f',
	),
	...
	'multi' => array(
		...
		*/
		'sources' => array('facebook', 'twitter', 'google', 'yahoo', 'hyves', 'OpenID', 'SURFguest'),
	),
